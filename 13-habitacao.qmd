...
```{r}
#| label: tbl-hab-improvisados
#| tbl-cap: "Domicílios improvisados em João Pessoa (PB), comparando os setores de Favela e Comunidade Urbana aos demais setores, Censo 2022."
#| message: false
jp_sc |>
  mutate(
...
```{r}
#| label: tbl-hab-orla
#| tbl-cap: "Seis bairros mais orientais de João Pessoa (PB), portanto os mais próximos do litoral, e suas proporções de domicílios não ocupados, Censo 2022."
#| message: false
#| warning: false
...
```{r}
#| label: tbl-hab-densidade
#| tbl-cap: "Moradores por dormitório em João Pessoa (PB), com média, mediana e proporção de domicílios acima de dois moradores por dormitório, e respectivos intervalos de confiança, microdados da amostra do Censo 2010."
#| message: false
pa_jp |>
  summarise(
...
```{r}
#| label: tbl-hab-setor-cnefe
#| tbl-cap: "Incompatibilidade entre os códigos de setor censitário do CNEFE e dos Agregados por Setor Censitário em João Pessoa (PB), Censo 2022."
