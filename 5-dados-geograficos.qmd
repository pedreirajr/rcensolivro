...
-   [`uf_br.gpkg`](https://github.com/pedreirajr/rcensolivro/releases/download/dados/uf_br.gpkg) — polígonos dos estados do Brasil
-   [`ssa.gpkg`](https://github.com/pedreirajr/rcensolivro/releases/download/dados/ssa.gpkg) — polígono do município de Salvador
-   [`bairros_ssa.geojson`](https://github.com/pedreirajr/rcensolivro/releases/download/dados/bairros_ssa.geojson) — polígonos dos bairros de Salvador
-   [`escolas_ssa.gpkg`](https://github.com/pedreirajr/rcensolivro/releases/download/dados/escolas_ssa.gpkg) — pontos das escolas de Salvador
-   [`smsl_est.gpkg`](https://github.com/pedreirajr/rcensolivro/releases/download/dados/smsl_est.gpkg) — estações do metrô de Salvador
-   [`smsl_linhas.gpkg`](https://github.com/pedreirajr/rcensolivro/releases/download/dados/smsl_linhas.gpkg) — linhas do metrô de Salvador
-   [`pop_uf_br.csv`](https://github.com/pedreirajr/rcensolivro/releases/download/dados/pop_uf_br.csv) — população por UF (Censo 2022)
...
#| cache: true
#| message: false
url_base <- "https://github.com/pedreirajr/rcensolivro/releases/download/dados/"
...
-   [`estab_sau_ba.gpkg`](https://github.com/pedreirajr/rcensolivro/releases/download/dados/estab_sau_ba.gpkg) — estabelecimentos de saúde da Bahia
-   [`reg_sau_ba.gpkg`](https://github.com/pedreirajr/rcensolivro/releases/download/dados/reg_sau_ba.gpkg) — regiões de saúde da Bahia
