...
::: callout-note
Lembre-se de que o `pivot_longer()`, visto no Capítulo 3, empilha em duas colunas aquelas indicadas em `cols`, guardando os nomes originais na coluna nomeada por `names_to` e os valores na coluna nomeada por `values_to`. A conversão é necessária aqui porque o `ggplot2` mapeia colunas para elementos visuais. Para colorir as barras por sexo, o sexo precisa estar em uma coluna, e não espalhado por vinte e duas colunas diferentes.
:::
