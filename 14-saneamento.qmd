...
```{r}
#| label: tbl-san-ivs
#| tbl-cap: "Indicadores de abastecimento de água e esgotamento sanitário inadequados em Macapá (AP), nos moldes da dimensão de Infraestrutura Urbana do IVS, Censo 2022."
macapa_sc <- macapa_sc |>
  mutate(
...
#| tbl-cap: "Bairros de Macapá (AP) com maior proporção de domicílios que lançam esgoto em vala ou curso d'água, entre os que possuem ao menos trezentos domicílios, Censo 2022."
#| message: false
bairros <- macapa_sc |>
...
```{r}
#| label: tbl-san-sem-rede
#| tbl-cap: "Bairros de Macapá (AP) inteiramente sem ligação à rede geral de esgoto e o total de domicílios neles situados, Censo 2022."
bairros |>
  summarise(
...
```{r}
#| label: tbl-san-raca
#| tbl-cap: "Acesso à rede de água e à rede de esgoto em Macapá (AP) segundo a cor ou raça da pessoa responsável pelo domicílio, Censo 2022."
#| message: false
desigualdade <- tibble(
...
```{r}
#| label: tbl-san-entorno-cobertura
#| tbl-cap: "Cobertura da Pesquisa Urbanística do Entorno dos Domicílios nos setores urbanos de Macapá (AP), Censo 2022."
#| message: false
#| warning: false
...
```{r}
#| label: tbl-san-entorno-2022
#| tbl-cap: "Domicílios de Macapá (AP) com e sem via pavimentada e com e sem bueiro ou boca de lobo no entorno, entre os investigados pela Pesquisa Urbanística, Censo 2022."
#| message: false
tibble(
...
```{r}
#| label: tbl-san-entorno-comparacao
#| tbl-cap: "Pavimentação e presença de bueiro ou boca de lobo no entorno dos domicílios de Macapá (AP), Censos de 2010 e 2022."
#| message: false
tibble(
